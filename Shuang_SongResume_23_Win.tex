...
Author and $\mathrm{Co}$-author of 3 International SCI Papers during studying period.

\section*{Bachelor of Medicine}
Southwest Medical University $\left[\begin{array}{c}\square \\ \hline\end{array}\right.$
...
\begin{tabular}{lll}
\begin{tabular}{l}
Certified Blockchain Solidity \\
Developer $\square$ \\
Advanced \\
\end{tabular} & \begin{tabular}{l}
Certified React.js Developer $\square$ \\
Advanced \\
\end{tabular} & \begin{tabular}{l}
Certified Kubernetes \\
Application Developer $\square$ \\
\end{tabular} \\
Coursera Deep Learning & \begin{tabular}{l}
